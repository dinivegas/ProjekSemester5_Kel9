                                ...
                                <table id="datatb" class="table table-bordered table-hover">
                                    ...
                                    <?php 
                                        ...
                                        <tr>
                                            ...
                                            <?php echo anchor('admin/data_psikolog/hapus/'. $pkg->id_psikolog, '<div class="btn btn-danger btn-sm"><i class="fa fa-trash"></i></div>') ?></td>
                                                        ...
                                                        <div class="modal-body">
                                                            <form method="post" action="<?php echo base_url().'admin/data_psikolog/update_aksi/'. $pkg->id_psikolog ?>">
                                                                    ...
                                                                    <div class="form-group">
                                                                        <label>NAMA</label>
                                                                        <input type="text" name="nama" class="form-control" value="<?= $pkg->nama_psikolog ?>">
                                                                    </div>

                                                                    <div class="form-group">
                                                                        <label>NOMOR TELEPON</label>
                                                                        <input type="text" name="no_hp" class="form-control" value="<?= $pkg->nohp_psikolog ?>">
                                                                    </div>

                                                                    <div class="form-group">
                                                                        <label>E-MAIL</label>
                                                                        <input type="text" name="email" class="form-control" value="<?= $pkg->email_psikolog ?>">
                                                                    </div>

                                                                    <div class="form-group">
                                                                        <label>ALAMAT</label>
                                                                        <input type="text" name="alamat" class="form-control" value="<?= $pkg->alamat_psikolog ?>">
                                                                    </div>

                                                                    <div class="form-group">
                                                                        <label>BIDANG</label>
                                                                        <input type="text" name="bidang" class="form-control" value="<?= $pkg->bidang_psikolog ?>">
                                                                    </div>

                                                                    <div class="form-group">
                                                                        <label>FOTO</label>
                                                                        <input type="file" name="foto" class="form-control" value="<?= $pkg->foto_psikolog ?>">
                                                                    </div>
                                                                    <div class="form-group">
